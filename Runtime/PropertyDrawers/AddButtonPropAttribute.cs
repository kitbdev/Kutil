...
namespace Kutil {
    ...
    public class AddButtonPropAttribute : PropertyAttribute {
        ...
        public AddButtonPropAttribute(string buttonMethodName, string buttonLabel = null, object[] parameters = null, PropLayout buttonLayout = PropLayout.Above, float btnWidth = 50, float btnWeight = 1, bool allowMultipleCalls = true) {
