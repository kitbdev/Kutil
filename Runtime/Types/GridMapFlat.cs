...
//     [System.Serializable]
//     public abstract class GridCellFlat<TGridType> {

//         // cant be serialized because circular dependency
//         [NonSerialized]
//         GridMapFlat<TGridType> _map;
//         [SerializeField, ReadOnly]
//         Vector2Int _pos;

//         public GridMapFlat<TGridType> map { get => _map; private set => _map = value; }
//         public Vector2Int pos { get => _pos; private set => _pos = value; }
//         public Vector2Int worldPos => map?.originPos2 + pos ?? Vector2Int.zero;

//         public GridCellFlat(GridMapFlat<TGridType> map, Vector2Int pos) {
//             this.map = map;
//             this.pos = pos;
//         }
//         public void DeserializeSetMap(GridMapFlat<TGridType> map) {
//             this.map = map;
//         }
...
//     public static class GridMapFlat {
//         // static stuff
...
//     [System.Serializable]
//     public class GridMapFlat<TGridObject> : ISerializationCallbackReceiver {
...
//         //     grid = new TGridObject[volume];
//         // }
//         public GridMapFlat(int width, int height, Func<GridMapFlat<TGridObject>, Vector2Int, TGridObject> createFunc = null, float gridSize = 1f) {
//             this.width = width;
//             this.height = height;
//             this.gridSize = gridSize;
//             grid = new TGridObject[volume];
...
//                     if (gridObject is GridCellFlat<TGridObject> gridCell) {
